...
urlpatterns = [
    ...
    path("dev/hitl/runs/<slug:run_id>/", dev_hitl_views.get_run_payload, name="dev-hitl-run-api"),
    path("dev/hitl/approve-candidates/", dev_hitl_views.approve_candidates, name="dev-hitl-approve"),
    path("dev/hitl/progress/<slug:run_id>/stream/", dev_hitl_views.progress_stream, name="dev-hitl-progress"),

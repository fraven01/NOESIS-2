...
def test_strict_match_legacy_keys_positive():
    meta = {"tenant": "t1", "case": "c1", "source": "s1", "hash": "h1"}
    assert strict_match(meta, "t1", "c1") is True


def test_strict_match_legacy_keys_negative():
    meta = {"tenant": "t1", "case": "c1", "source": "s1", "hash": "h1"}
    assert strict_match(meta, "t1", "c2") is False


def test_strict_match_mixed_keys_positive():
    meta = {"tenant_id": "t1", "case": "c1", "source": "s1", "hash": "h1"}
    assert strict_match(meta, "t1", "c1") is True

...
class GraphNode:
    ...
    name: str
    runner: Callable[[Dict[str, Any], Dict[str, Any], Dict[str, Any]], Tuple[GraphTransition, bool]]
...
class CrawlerIngestionGraph:
    ...
    def _emit_event(self, node: str, transition: GraphTransition, graph_run_id: str) -> None:

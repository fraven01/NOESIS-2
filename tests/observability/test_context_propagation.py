...
class TestContextPropagation(unittest.TestCase):
    def setUp(self):
        ...
        self.propagator_patcher = patch("common.celery.TraceContextTextMapPropagator", create=True)
    ...
    def test_producer_injection(self):
        ...
        self.assertEqual(mock_sig.options["headers"]["traceparent"], "00-test_trace_id-span_id-01")
    ...
    def test_consumer_extraction(self, mock_task_call):
        ...
        self.MockPropagator.return_value.extract.assert_called_with(carrier=task.request.headers)
